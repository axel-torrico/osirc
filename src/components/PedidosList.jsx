...
function PedidosList({ pedidos, selectedPedido, onSelectPedido }) {
  return (
    <div className="w-80 border-r-2 border-gray-600 bg-gray-900 flex flex-col h-full">
      <div className="p-4 flex-shrink-0 bg-gray-900">
        <h2 className="text-xl font-bold mb-4 text-center">Pedidos</h2>
      </div>
      <div className="flex-1 px-4 pb-4 overflow-y-auto scrollbar-custom bg-gray-900">
